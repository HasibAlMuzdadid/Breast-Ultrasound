...
def create_train_data(data_path, name):
    ...
    np.save(os.path.join("D:/Dataset/BUSI with Ground Truth Augmented Malignant", "imgs_train_"+name+".npy"), imgs)
    np.save(os.path.join("D:/Dataset/BUSI with Ground Truth Augmented Malignant", "imgs_mask_train_"+name+".npy"), imgs_mask)
...
create_train_data("D:/Dataset/BUSI with Ground Truth Augmented Malignant/Train", "malignant")
...
def load_train_data(name):
    imgs_train = np.load("D:/Dataset/BUSI with Ground Truth Augmented Malignant/imgs_train_"+name+".npy")
    imgs_mask_train = np.load("D:/Dataset/BUSI with Ground Truth Augmented Malignant/imgs_mask_train_"+name+".npy")
...
def create_test_data(data_path2, name):
    ...
    np.save(os.path.join("D:/Dataset/BUSI with Ground Truth Augmented Malignant", "imgs_test_"+name+".npy"), imgs)
    np.save(os.path.join("D:/Dataset/BUSI with Ground Truth Augmented Malignant", "imgs_id_test_"+name+".npy"), imgs_mask)
    print("Saving to .npy files done")
...
create_test_data("D:/Dataset/BUSI with Ground Truth Augmented Malignant/Test", "malignant")
...
def load_test_data(name):
    imgs_test = np.load("D:/Dataset/BUSI with Ground Truth Augmented Malignant/imgs_test_"+name+".npy")
    imgs_id = np.load("D:/Dataset/BUSI with Ground Truth Augmented Malignant/imgs_id_test_"+name+".npy")
