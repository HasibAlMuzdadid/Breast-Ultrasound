...
imgs_train = np.load("/kaggle/input/udiat-benign/imgs_train_benign.npy")
imgs_mask_train = np.load("/kaggle/input/udiat-benign/imgs_mask_train_benign.npy")
...
imgs_test = np.load("/kaggle/input/udiat-benign/imgs_test_benign.npy")
imgs_id_test = np.load("/kaggle/input/udiat-benign/imgs_id_test_benign.npy")
...
model1 = get_model()
model1.load_weights("/kaggle/input/udiat-benign-model-3-fold-weights/benign_model_fold_01_weights.h5")
model2 = get_model()
model2.load_weights("/kaggle/input/udiat-benign-model-3-fold-weights/benign_model_fold_02_weights.h5")
model3 = get_model()
model3.load_weights("/kaggle/input/udiat-benign-model-3-fold-weights/benign_model_fold_03_weights.h5")
...
pred_mask = imgs_mask_test[15]
pred_mask.shape
plt.imshow(pred_mask,  cmap="gray")
# cv2.imwrite("pred_mask.png",pred_mask*255)


# In[24]:


test_image = imgs_test[15]
...
# imsave(os.path.join("/kaggle/working", "_Segmented_mask.png"), seg_mask)
