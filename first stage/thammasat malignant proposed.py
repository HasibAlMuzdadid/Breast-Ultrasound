...
imgs_train = np.load("/kaggle/input/thammasat-malignant/imgs_train_malignant.npy")
imgs_mask_train = np.load("/kaggle/input/thammasat-malignant/imgs_mask_train_malignant.npy")
...
imgs_test = np.load("/kaggle/input/thammasat-malignant/imgs_test_malignant.npy")
imgs_id_test = np.load("/kaggle/input/thammasat-malignant/imgs_id_test_malignant.npy")
...
model1 = get_model()
model1.load_weights("/kaggle/input/thammasat-malignant-model-3-fold-weights/malignant_model_fold_01_weights.h5")
model2 = get_model()
model2.load_weights("/kaggle/input/thammasat-malignant-model-3-fold-weights/malignant_model_fold_02_weights.h5")
model3 = get_model()
model3.load_weights("/kaggle/input/thammasat-malignant-model-3-fold-weights/malignant_model_fold_03_weights.h5")
...
data_path = "/kaggle/input/thammasat-malignant-generated-image/CycleGAN"  
...
gen_imgs_mask = ((0.2*gen_imgs_mask_1) + (0.4*gen_imgs_mask_2) + (0.4*gen_imgs_mask_3)) / (0.2 + 0.4 + 0.4)
...
# import shutil
# shutil.rmtree("/kaggle/working/udiat_malignant_generated_masks")
# os.remove("/kaggle/working/generated_masks.zip")

pred_dir = "/kaggle/working/thammasat_malignant_generated_masks"
...
files = glob.glob("/kaggle/input/thammasat-malignant-generated-image/CycleGAN/*") 
len(files)
files[0]
...
sorted_gen_images = sorted(os.listdir("/kaggle/input/thammasat-malignant-generated-image/CycleGAN/"))
sorted_gen_masks = sorted(os.listdir("/kaggle/working/thammasat_malignant_generated_masks/"))

# Load the images and masks from the folder
gen_images = [cv2.imread(os.path.join("/kaggle/input/thammasat-malignant-generated-image/CycleGAN/", img)) for img in sorted_gen_images]
gen_masks = [cv2.imread(os.path.join("/kaggle/working/thammasat_malignant_generated_masks/", msk)) for msk in sorted_gen_masks]
...
# !zip -r generated_masks.zip /kaggle/working/thammasat_malignant_generated_masks/
