...
def plot_confusion_matrix(cm, classes, normalize=True, title='Confusion matrix', cmap=plt.cm.summer):
    ...
    fig.savefig("/kaggle/working/nasnetlarge_confusion_matrix.png")
...
fname = "/kaggle/working/nasnetlarge_weights.h5"
...
model.load_weights("/kaggle/working/nasnetlarge_weights.h5")
...
plt.show()
fig.savefig("/kaggle/working/nasnetlarge_result.png")
