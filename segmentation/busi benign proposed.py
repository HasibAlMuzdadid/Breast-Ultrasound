...
model1 = get_model()
model1.load_weights("/kaggle/input/benign-model-3-fold-weights/benign model fold weights/benign_model_fold_01_weights.h5")
model2 = get_model()
model2.load_weights("/kaggle/input/benign-model-3-fold-weights/benign model fold weights/benign_model_fold_02_weights.h5")
model3 = get_model()
model3.load_weights("/kaggle/input/benign-model-3-fold-weights/benign model fold weights/benign_model_fold_03_weights.h5")
...
imgs_mask_test = ((0.4*img_1) + (0.4*img_2) + (0.2*img_3)) / (0.4 + 0.4 + 0.2)
