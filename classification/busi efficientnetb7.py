...
def plot_confusion_matrix(cm, classes, normalize=True, title='Confusion matrix', cmap=plt.cm.summer):
    ...
    fig.savefig("/kaggle/working/efficientnetb7_confusion_matrix.png")
...
fname = "/kaggle/working/efficientnetb7_weights.h5"
...
model.load_weights("/kaggle/working/efficientnetb7_weights.h5")
...
plt.show()
fig.savefig("/kaggle/working/efficientnetb7_result.png")
