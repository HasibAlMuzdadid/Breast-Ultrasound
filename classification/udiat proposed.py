...
model_e = models[0]        
model_e.load_weights("/kaggle/input/udiat-with-syn-weights/Weights/efficientnetb7_weights.h5")

model_n = models[1]       
model_n.load_weights("/kaggle/input/udiat-with-syn-weights/Weights/nasnetlarge_weights.h5")

model_r = models[2]       
model_r.load_weights("/kaggle/input/udiat-with-syn-weights/Weights/resnet50v2_weights.h5")
...
stacked_model.load_weights("/kaggle/input/udiat-with-syn-stacked-ensemble-weight/stacked_ensemble_weights.h5")
